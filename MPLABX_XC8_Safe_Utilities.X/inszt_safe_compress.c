...
FILE UNDER TEST  : "C:\LDRA_Workarea\Examples\Tlps\Microchip\MPLABX_XC8_Workspace\MPLABX_XC8_Safe_Utilities.X\safe_comp
DATE OF ANALYSIS : Thu Apr 08 16:39:52 2021
*/
...
#define safe_compress_7zzopen                                                                                 zzopen
 extern int safe_compress_7zzopen                                                                               ;
//#define safe_compress_7zqqzqz1                                                                                zqqzqz1
#define QQQLDRA_PORT 
...
#define LASTELEMENT                                                                                                                                                                                                                                                 
#include "safe_compress_7zbelem.def"                                                                                                                                                                                                                                
#undef ELEMENT                                                                                                                                                                                                                                                      
#undef LASTELEMENT                                                                                                                                                                                                                                                  
  } bitmapstruct = {                                                                                                                                                                                                                                                
#define ELEMENT(N) 0,                                                                                                                                                                                                                                               
...
#undef ELEMENT                                                                                                                                                                                                                                                      
  ...
  static int safe_compress_7zqqzqz(qqnull_params);                                                                                                                                                                                                                  
  static int safe_compress_7zqqzqz1(qqnull_params);                                                                                                                                                                                                                 
  static int safe_compress_7zqendz (int qqqi);                                                                                                                                                                                                                      
  static int safe_compress_7zqzqzq (int qqqi);                                                                                                                                                                                                                      
...
/*
 * Compress a string into an array
 */
...
bool
  ...
  uint8_t anArray1 [] ,
  const char_t aString1 [] )
#if defined(LDRA_dummy_global) || defined(LDRA_dummy_7_1)
  {
 ...
 (  /* 50 */
  ...
  ? (bitmapstruct.element0 |= (1 <<  2 ), 1)
  : (bitmapstruct.element0 |= (1 <<  1 ), 0) ) /* 54 */
      ||
      ( aString1 == ( char_t * ) 0 )
      )
  ) /* 1 */
 {
  ((int)(bitmapstruct.element0 |= (1 <<  3))); /* 1 */
      {
        compress_status = false ;
      }
  ((int)(bitmapstruct.element0 |= (1 <<  4))); /* 3 */
 }
    else
  { 
  ((int)(bitmapstruct.element0 |= (1 <<  5))); /* 2 */
      {
...
#endif /* endof dummy_ */
/*
 * Uncompress an array into a string
 */
...
bool
  ...
  const uint8_t anArray [] ,
  const int16_t arraySize )
#if defined(LDRA_dummy_global) || defined(LDRA_dummy_7_2)
  {
  ...
  ) /* 1 */
 {
  ...
  ((int)(bitmapstruct.element1 |= (1 <<  4))); /* 2 */
      {
        uncompress_status = true ;
        /* TODO */
      }
 }
  ((int)(bitmapstruct.element1 |= (1 <<  5))); /* 30 */
    safe_compress_7zqendz                                                                                (      14 ) ; /* 30 */  
    return
    uncompress_status ;
  }
#else
...
#define QQQFIXEDSIZE                                                                                                                                                                                                                                                
   ...
   * -----------------------------------------------------------------------------                                                                                                                                                                                  
   */                                                                                                                                                                                                                                                               
  static int safe_compress_7zscanf(char* qqscan_str)                                                                                                                                                                                                                
  {                                                                                                                                                                                                                                                                 
    int qqvalue;                                                                                                                                                                                                                                                    
    int qqisign;                                                                                                                                                                                                                                                    
    char* qqcptr;                                                                                                                                                                                                                                                   
...
#define QQQTEMP1                                                                                                                                                                                                                                                    
   ...
   * superceded by safe_compress_7zqqzqz1 below.                                                                                                                                                                                                                    
   * -----------------------------------------------------------------------------                                                                                                                                                                                  
   */                                                                                                                                                                                                                                                               
  static int safe_compress_7zqqzqz(qqnull_params)                                                                                                                                                                                                                   
  {                                                                                                                                                                                                                                                                 
    if ( safe_compress_7zzopen != 1 )                                                                                                                                                                                                                               
    {                                                                                                                                                                                                                                                               
      safe_compress_7zzopen = 1;                                                                                                                                                                                                                                    
    }                                                                                                                                                                                                                                                               
    return 1;                                                                                                                                                                                                                                                       
  } /* end of zqqzqz */                                                                                                                                                                                                                                             
   ...
   * opened (safe_compress_7zzopen = 0 ).                                                                                                                                                                                                                           
